...
const TRANSLATIONS = {
  pt: {
    ...
    'proj.nav.h3': 'Neblina — Smart Cloud',
    'proj.nav.p': 'Gestor multi-cloud inteligente projetado para unificar sua vida digital. Oferece integração com Google Drive, MEGA, Dropbox e OneDrive com criptografia de ponta a ponta.',
    ...
    'proj.link': 'Ver Projeto', 'proj.cta': 'Ver todos os projetos no GitHub →',
  ...
  en: {
    ...
    'proj.nav.h3': 'Neblina — Smart Cloud',
    'proj.nav.p': 'Intelligent multi-cloud manager designed to unify your digital life. Features seamless integration with Google Drive, MEGA, Dropbox, and OneDrive with end-to-end encryption.',
    'proj.ocr.h3': 'Multimeter OCR Engine',
    ...
    'proj.link': 'View Project', 'proj.cta': 'View all projects on GitHub →',
    'lab.h2': 'Hand Gesture Lab',
  ...
  es: {
    ...
    'proj.nav.h3': 'Neblina — Smart Cloud',
    'proj.nav.p': 'Gestor multi-nube inteligente diseñado para unificar tu vida digital. Ofrece integración con Google Drive, MEGA, Dropbox y OneDrive con cifrado de extremo a extremo.',
    ...
    'proj.link': 'Ver Proyecto', 'proj.cta': 'Ver todos los proyectos en GitHub →',
  ...
  zh: {
    ...
    'proj.nav.h3': 'Neblina — 智能云管家',
    'proj.nav.p': '旨在统一您数字生活的智能多云管理工具。支持 Google Drive、MEGA、Dropbox 和 OneDrive 的无缝集成，并提供端到端加密保护。',
    ...
    'proj.link': '查看项目', 'proj.cta': '在 GitHub 上查看所有项目 →',
    'lab.h2': '手势识别实验室',
